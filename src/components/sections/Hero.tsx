  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[100dvh] text-center px-4 overflow-hidden bg-[#050505]">
      ...
      <div className="relative z-10 flex flex-col items-center mix-blend-normal"> 
        ...
        {/* Etiqueta Técnica - Ahora enfatiza el estatus de laboratorio */}
        <motion.div 
        ...
        <div className="relative">
            ...
            >
                {/* 1. Nombre de la marca SÓLIDO y gigante */}
                BIOSETA <br />
                
                {/* 2. Concepto "EVOLUCIÓN" en Outline (Conecta con el footer) */}
        ...
        {/* SUBTÍTULO CIENTÍFICO - Más técnico y específico */}
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
...
// ... (El componente FungiTopoColor se mantiene igual)
